...
%Bsp:  
?- insertMeasurement(assert,unordIdx,integer,100000,100).
...
Value: integer*/
%Bsp:
?- storageInsert(assert,on,[100000,200000,300000,400000,500000,600000,700000,800000,900000,1000000],random(26010,5548,23873,425005073),unordIdx,integer).
